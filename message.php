...
<a href="s_m.php">
	<input type="button" class="btn btn-info" name="answer" value="Compose Message"  style="width:40%;float:right" >
</a>
<a href="r_m.php">
	<input type="button" class="btn btn-info" name="answer" value="Recevied"  style="width:40%;float:left" >	  
</a>
	</div>
      <div id="result"></div>
   </div>
