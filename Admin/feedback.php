	    ...
	    <table id="datatables" class="display" style="padding-top:10px;">
				...
				<thead >
                    <tr style="background-color:#0099FF;color:white;">
						...
						<th><div align="center">Email</div><div align="right"><i class="glyphicon glyphicon-sort-by-attributes"></i></div></th>
						<th><div align="center">Topic</div><div align="right"><i class="glyphicon glyphicon-sort-by-attributes"></i></div></th>
                      ...
                      <tbody>
                    <?php
						$table = mysqli_query($connect,("select * from feedback "));
						...
						<tr>
                            ...
                            <td align="center">
								...
								<?php echo("<a href='sale_delete.php?f_id=".$row['f_id']."' onclick='return checkDelete()'>"); ?>
