...
?>
          ...
          <div class="row" >
		  <form name="fm" action="si_update_action.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="n" readonly placeholder="Insert Product Name..." value="<?php echo($row['si_product']);?>" class="form-control" maxlength="50" required>
				</div>
                <!-- /.input group -->
              </div>
              <!-- /.form-group -->
