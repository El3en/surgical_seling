...
<section id="main-content">
	...
	?>
		...
		<h3 class="box-title"><span><label data-widget="collapse" >Purchase Surgical Product (Click)</label></span></h3>
          ...
          <div class="row">
		  <form name="fm" action="purchase_action1.php" method="POST" enctype="multipart/form-data">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="sp" readonly value="<?php echo($aa['si_product']);?>" class="form-control">
					...
					?>
						...
						<tr>
							...
							<td align="center" style="background-color:#009999;color:white;">
								 ...
								 <?php echo("<a href='surgical_instrument.php'>"); ?>
								 <?php echo("<div style='color:white;' title='View Product'>". $row['si_product']. "</div></a>"); ?>
							</td>
