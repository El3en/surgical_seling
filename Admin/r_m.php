        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
             <h3 class="box-title" style="padding-bottom:10px;">Recevied Messages</h3>
	    ...
	    <table id="datatables" class="display" style="padding-top:10px;">
				...
				<thead >
                    <tr style="background-color:#0099FF;color:white;">
                      ...
                      <tbody>
                    <?php
						$table = mysqli_query($connect,("select * from message "));
						...
						<tr>
                            ...
                            <td>
								...
								<?php echo("<a href='c_m.php?u_id=".$row['u_id']."' >"); ?>
								<?php echo("<i class='fa fa-reply' title='Reply' ></i></a>"); ?>
								
								<?php echo("<a href='message_delete.php?m_id=".$row['m_id']."' onclick='return checkDelete()'>"); ?>
