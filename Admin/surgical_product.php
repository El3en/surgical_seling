	    ...
	    <table id="datatables" class="display" style="padding-top:10px;">
				...
				<thead >
                    <tr style="background-color:#0099FF;color:white;">
                      ...
                      <tbody>
                    <?php
						$table = mysqli_query($connect,("select p_id,sp_product,image,description from products "));
					
						while ($row = mysqli_fetch_array($table)) 
						{
							if($row['sp_product'] != NULL)
								{
							?>
						...
						<tr>
							...
							<td align="center">
								<?php echo("<a href='surgical_product_detail.php?p_id=".$row['p_id']."'>"); ?>
								<?=$row['sp_product']?><?php echo("</a>"); ?>
                            ...
                            <td>
								...
								<?php echo("<a href='surgical_product_edit.php?p_id=".$row['p_id']."'>"); ?>
