        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
             <h3 class="box-title" style="padding-bottom:10px;">Product Sale Price Detail</h3>
	    ...
	    <table id="datatables" class="display" style="padding-top:10px;">
				...
				<thead >
                    <tr style="background-color:#0099FF;color:white;">
						...
						<th><div align="center">Sale Price</div><div align="right"><i class="glyphicon glyphicon-sort-by-attributes"></i></div></th>
                      ...
                      <tbody>
                    <?php
						$table = mysqli_query($connect,("select * from price_insert "));
					
						while ($row = mysqli_fetch_array($table)) 
						{
							$user = mysqli_query($connect,("select * from products where p_id = '".$row['p_id']."' "));
							$u = mysqli_fetch_array($user);
								
								if($u['si_product'] != NULL)
								{
							?>
						...
						<tr>
                            ...
                            <td>
								...
								<?php echo("<a href='si_p_delete.php?pi_id=".$row['pi_id']."' onclick='return checkDelete()'>"); ?>
